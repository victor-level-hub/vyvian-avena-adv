...
- [ ] Victor: `git pull` em `C:\Users\victor.sousa\Projetos\vyvian-avena-adv` para trazer `134dd49`…`082cf63` (redesign, filtros, lightbox, marca de água, tema livre, fotos no corpo, Banco de Imagens).
