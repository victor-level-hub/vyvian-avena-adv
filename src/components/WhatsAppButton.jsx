export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gold text-warmwhite font-body text-sm font-medium shadow-lg hover:scale-105 transition-transform duration-300"
    >
