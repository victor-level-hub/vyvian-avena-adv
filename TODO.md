...
- [ ] **Redes Sociais — fecho**: teste ponta-a-ponta autenticado das abas Insights (Atualizar → gerar artigo → 4 imagens → pré-visualizar) e Instagram (KPIs, gráfico, grelha de publicações).
