...
export const IconSupport = (p) => (
  <Svg {...p}><path d="M4 13v-1a8 8 0 0 1 16 0v1" /><path d="M4 13h2.5a1 1 0 0 1 1 1v3.5a1 1 0 0 1-1 1H5.5A1.5 1.5 0 0 1 4 17v-4Z" /><path d="M20 13h-2.5a1 1 0 0 0-1 1v3.5a1 1 0 0 0 1 1h1a1.5 1.5 0 0 0 1.5-1.5V13Z" /><path d="M20 17v1.5a2.5 2.5 0 0 1-2.5 2.5H13" /></Svg>
);
